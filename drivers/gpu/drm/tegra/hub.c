...
static const u64 tegra_shared_plane_modifiers[] = {
	TEGRA_BLOCK_LINEAR_2D(0),
	TEGRA_BLOCK_LINEAR_2D(1),
	TEGRA_BLOCK_LINEAR_2D(2),
	TEGRA_BLOCK_LINEAR_2D(3),
	TEGRA_BLOCK_LINEAR_2D(4),
	TEGRA_BLOCK_LINEAR_2D(5),
	 ...
	 * it isn't supported.
	 */
	TEGRA_BLOCK_LINEAR_2D(0) | DRM_FORMAT_MOD_NVIDIA_SECTOR_LAYOUT,
	TEGRA_BLOCK_LINEAR_2D(1) | DRM_FORMAT_MOD_NVIDIA_SECTOR_LAYOUT,
	TEGRA_BLOCK_LINEAR_2D(2) | DRM_FORMAT_MOD_NVIDIA_SECTOR_LAYOUT,
	TEGRA_BLOCK_LINEAR_2D(3) | DRM_FORMAT_MOD_NVIDIA_SECTOR_LAYOUT,
	TEGRA_BLOCK_LINEAR_2D(4) | DRM_FORMAT_MOD_NVIDIA_SECTOR_LAYOUT,
	TEGRA_BLOCK_LINEAR_2D(5) | DRM_FORMAT_MOD_NVIDIA_SECTOR_LAYOUT,
